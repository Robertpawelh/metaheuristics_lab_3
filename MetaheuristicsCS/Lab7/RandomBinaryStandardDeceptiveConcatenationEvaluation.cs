...
{
    class RandomBinaryStandardDeceptiveConcatenationEvaluation : CBinaryStandardDeceptiveConcatenationEvaluation
    {
        private List<int> GenesOrder;

        public RandomBinaryStandardDeceptiveConcatenationEvaluation(int iBlockSize, int iNumberOfBlocks, int? seed) : base(iBlockSize, iNumberOfBlocks)
        {
