...
CRealHorizontalScalingEvaluation::CRealHorizontalScalingEvaluation(IEvaluation<double, double> &cRealEvaluation, vector<double> &vFactors)
	: CEvaluation<double, double>(cRealEvaluation.iGetSize(), cRealEvaluation.tGetMaxValue()), c_real_evaluation(cRealEvaluation), v_factors(vFactors)
{
...
double CRealHorizontalScalingEvaluation::t_evaluate(vector<double> &vSolution)
{
	...
	return c_real_evaluation.tEvaluate(v_scaled_solution);
}//double CRealHorizontalScalingEvaluation::t_evaluate(vector<double> &vSolution)


CRealStepEvaluation::CRealStepEvaluation(IEvaluation<double, double> &cRealEvaluation, vector<int> &vStepSizes)
	: CEvaluation<double, double>(cRealEvaluation.iGetSize(), cRealEvaluation.tGetMaxValue()), c_real_evaluation(cRealEvaluation), v_step_sizes(vStepSizes)
{

}//CRealStepEvaluation::CRealStepEvaluation(IEvaluation<double, double> &cRealEvaluation, vector<int> &vStepSizes)

double CRealStepEvaluation::t_evaluate(vector<double> &vSolution)
{
	...
	double d_value = c_real_evaluation.tEvaluate(v_solution_with_steps);

	if (d_value == tGetMaxValue())
	{
		d_value = c_real_evaluation.tEvaluate(vSolution);
...
double CRealSphereEvaluation::t_evaluate(vector<double> &vSolution)
{
	double d_value = 0;
...
CRealSphere10Evaluation::CRealSphere10Evaluation(int iSize)
	: CProxyEvaluation<double, double>((IEvaluation<double, double>**)&pc_vertical_scaling_evaluation)
{
...
CRealEllipsoidEvaluation::CRealEllipsoidEvaluation(int iSize)
	: CProxyEvaluation<double, double>((IEvaluation<double, double>**)&pc_horizontal_scaling_evaluation)
{
	pc_sphere_evaluation = new CRealSphereEvaluation(iSize);
...
CRealStep2SphereEvaluation::CRealStep2SphereEvaluation(int iSize)
	: CProxyEvaluation<double, double>((IEvaluation<double, double>**)&pc_step_evaluation)
{
...
double CRealRastriginEvaluation::t_evaluate(vector<double> &vSolution)
{
...
double CRealAckleyEvaluation::t_evaluate(vector<double> &vSolution)
{
